export const spaceImages = "https://alpar2.sfo3.digitaloceanspaces.com";
export const defaultNoImage = `${spaceImages}/Alpar/no-image.jpg`;

export const CLIENT_EMAILS_ACCEPT_STORE = [
  "ti@alpardobrasil.com.br",
  "t.i@alpardobrasil.com.br",
];

export const SELLER_EMAILS_ACCEPT_STORE = [
  ...
  "cleiton.kaiser@alpardobrasil.com.br",
  "paulo.araujo@alpardobrasil.com.br",
];
